...
exports.payment = (req, res) => {
    ...
    params['MID'] = process.env.PAYTM_MID,
        ...
        params['CALLBACK_URL'] = 'https://zcad-server.herokuapp.com/payment-callback',
        params['EMAIL'] = email,
            ...
            PaytmChecksum.generateSignature(paytmParams, process.env.PAYTM_MERCHANT_KEY).then(function (checksum) {
                ...
                var post_req = https.request(options, function (post_res) {
                    ...
                    post_res.on('end', function () {
                        ...
                        if (resObj.STATUS === "TXN_SUCCESS") {
                            order.updateOne({ orderId: resObj.ORDERID }, { $set:{transactionData: resObj }},function(){console.log('transaction updated')})
                            res.sendFile(__dirname + '/txnSuccess.html');
                        }
                        else {
                            res.sendFile(__dirname + '/txnFailure.html');
                        }
                    });
                });
